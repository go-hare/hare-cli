...
const RELEASE_TARGETS = {
  "windows-x64": {
    ...
    assetName: "hare-cli-windows-x64.exe",
  },
  "linux-x64": {
    bunTarget: "bun-linux-x64",
    assetName: "hare-cli-linux-x64",
  },
  "linux-x64-baseline": {
    bunTarget: "bun-linux-x64-baseline",
    assetName: "hare-cli-linux-x64-baseline",
  },
  "linux-arm64": {
    bunTarget: "bun-linux-arm64",
    assetName: "hare-cli-linux-arm64",
  },
  "darwin-x64": {
    bunTarget: "bun-darwin-x64",
    assetName: "hare-cli-darwin-x64",
  },
  "darwin-arm64": {
    bunTarget: "bun-darwin-arm64",
    assetName: "hare-cli-darwin-arm64",
  },
};
